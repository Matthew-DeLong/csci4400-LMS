...
public class LibrarianCheckOutItemPanel extends JPanel implements ActionListener, Messagable{
	 ...
	 * Create the panel.
	 */
	public LibrarianCheckOutItemPanel() {
		setSize(800,579);
		setLayout(null);
		
		JLabel lblNewLabel = new JLabel("Check Out Item");
		...
		checkOutButton.setBounds(10, 197, 133, 23);
		add(checkOutButton);
	...
	public void actionPerformed(ActionEvent e) {
		...
		case "checkout":
			LibrarianActionsControl.checkOutItem(this, textField.getText(), (String) comboBox.getSelectedItem(), memberField.getText());
			break;
		}
